...
import com.lq.animationdemo.simple.tween.*
...
class TweenAnimationActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onClick(v: View?) {
        when (v?.id) {
            R.id.alphaBtn -> {
                startActivity(Intent().setClass(this, AlphaTweenAnimationActivity::class.java))
            }
            R.id.scaleBtn -> {
                startActivity(Intent().setClass(this, ScaleTweenAnimationActivity::class.java))
            }
            R.id.translateBtn -> {
                startActivity(Intent().setClass(this, TranslateTweenAnimationActivity::class.java))
            }
            R.id.rotateBtn -> {
                startActivity(Intent().setClass(this, RotateTweenAnimationActivity::class.java))
            }
            R.id.setBtn -> {
                startActivity(Intent().setClass(this, SetTweenAnimationActivity::class.java))
            }
        }
    }
}